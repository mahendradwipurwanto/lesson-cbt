	...
	<div class="col-lg-9">
		<div class="d-grid gap-3 gap-lg-5">
			...
			<div class="card">
				...
				<div class="card-body">
					<!-- Form -->
					<form action="<?= site_url('pengguna/savePribadi');?>" method="POST" class="js-validate needs-validation" novalidate>
						<!-- Form -->
						<div class="row mb-4">
							<label for="namalengkapLabel" class="col-sm-3 col-form-label form-label">Nama lengkap</label>

							<div class="col-sm-9">
								<input type="text" class="form-control" name="name" id="namalengkapLabel" placeholder="Nama lengkap anda"
									aria-label="Nama lengkap anda" value="<?= $user->name;?>" required>
							</div>
						</div>
						<!-- End Form -->
						...
						<div class="row mb-4">
							<label for="birthdateLabel"
								class="col-sm-3 col-form-label form-label">Tanggal lahir</label>

							<div class="col-sm-9">
								<input type="date" class="form-control" name="birthdate" id="birthdateLabel"
									placeholder="Your birthdate" aria-label="Your birthdate" value="<?= date("Y-m-d", strtotime($user->birthdate));?>" required>
							</div>
						</div>
						<!-- End Form -->
								...
								<div class="input-group input-group-sm-vertical">
									...
									<label class="form-control" for="gender-laki-laki">
										<span class="form-check">
											<input type="radio" class="form-check-input" name="gender" value="laki-laki" <?php if($user->gender == 'laki-laki'):?>checked<?php endif;?>
									...
									<label class="form-control" for="gender-perempuan">
										<span class="form-check">
											<input type="radio" class="form-check-input" name="gender" value="perempuan" <?php if($user->gender == 'perempuan'):?>checked<?php endif;?>
												id="gender-perempuan">
			...
			<div id="passwordSection" class="card">
				...
				<div class="card-body">
					...
					<form id="changePasswordForm" action="<?= site_url('pengguna/ubahPassword');?>" method="POST"
						...
						<!-- Form -->
						<div class="row mb-4">
							<label for="passwordSaatIniLabel" class="col-sm-3 col-form-label form-label">Password saat ini</label>
						...
						<!-- Form -->
						<div class="row mb-4">
							<label for="confirmNewPasswordLabel" class="col-sm-3 col-form-label form-label">Konfirmasi
								password baru</label>
