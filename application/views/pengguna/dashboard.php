		...
		<div class="tab-pane fade show active" id="nav-one-eg1" role="tabpanel" aria-labelledby="nav-one-eg1-tab">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-4">
					<div class="course-card shadow-sm cursor"
							...
							<div class="course-card__content">
								<div class="pt-md-2">
									<div class="d-flex align-items-center mb-3 font-weight-bold text-xs">
										...
										<?= $val->categories;?>
										<?php if($val->status_peserta == 0):?>
										<span class="badge bg-secondary ms-2">Belum dikerjakan</span>
										<?php elseif($val->status_peserta == 1):?>
										<span class="badge bg-success ms-2">Selesai</span>
										<?php elseif($val->status_peserta == 2):?>
										<span class="badge bg-warning ms-2">Waktu habis</span>
										<?php endif;?>
									</div>
								...
								<td>
									<div class="d-flex align-items-center">
										<img class="avatar avatar-xss avatar-4x3 me-2"
											src="<?= base_url();?>assets/svg/brands/mastercard.svg"
