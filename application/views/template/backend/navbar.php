																...
																<div class="col-auto">
																	<div class="d-flex align-items-center">
																		...
																		<img class="avatar avatar-sm avatar-circle"
																			src="<?= base_url();?>assets/img/160x160/img3.jpg"
																	...
																	<div class="d-flex align-items-center">
																		...
																		<div class="avatar avatar-sm avatar-circle">
																			<img class="avatar-img"
																				src="<?= base_url();?>assets/img/160x160/img10.jpg"
																				alt="Image Description" />
																		</div>
																	</div>
																</div>
															...
															<div class="row">
																<div class="col-auto">
																	<div class="d-flex align-items-center">
																		...
																		<div class="avatar avatar-sm avatar-circle">
																			<img class="avatar-img"
																				src="<?= base_url();?>assets/svg/brands/google-icon.svg"
																				alt="Image Description" />
																		</div>
																	</div>
																</div>
															...
															<div class="row">
																<div class="col-auto">
																	<div class="d-flex align-items-center">
																		...
																		<div class="avatar avatar-sm avatar-circle">
																			<img class="avatar-img"
																				src="<?= base_url();?>assets/img/160x160/img7.jpg"
																				alt="Image Description" />
																		</div>
																	</div>
																</div>
															...
															<div class="row">
																<div class="col-auto">
																	<div class="d-flex align-items-center">
																		...
																		<div class="avatar avatar-sm avatar-circle">
																			<img class="avatar-img"
																				src="<?= base_url();?>assets/img/160x160/img5.jpg"
																				alt="Image Description" />
																		</div>
																	</div>
																</div>
															...
															<div class="row">
																<div class="col-auto">
																	<div class="d-flex align-items-center">
																		...
																		<div class="avatar avatar-sm avatar-circle">
																			<img class="avatar-img"
																				src="<?= base_url();?>assets/img/160x160/img8.jpg"
																				alt="Image Description" />
																		</div>
																	</div>
																</div>
										...
										<div class="card-body card-body-height">
												...
												<div class="d-flex align-items-center">
													<div class="flex-shrink-0">
														<img class="avatar avatar-xs avatar-4x3"
															src="<?= base_url();?>assets/svg/brands/atlassian-icon.svg"
															alt="Image Description" />
													</div>
											...
											<a class="dropdown-item" href="#">
												<div class="d-flex align-items-center">
													<div class="flex-shrink-0">
														<img class="avatar avatar-xs avatar-4x3"
															src="<?= base_url();?>assets/svg/brands/slack-icon.svg"
															alt="Image Description" />
													</div>
													<div class="flex-grow-1 text-truncate ms-3">
														<h5 class="mb-0">
											...
											<a class="dropdown-item" href="#">
												<div class="d-flex align-items-center">
													<div class="flex-shrink-0">
														<img class="avatar avatar-xs avatar-4x3"
															src="<?= base_url();?>assets/svg/brands/google-webdev-icon.svg"
															alt="Image Description" />
													</div>
													<div class="flex-grow-1 text-truncate ms-3">
											...
											<a class="dropdown-item" href="#">
												<div class="d-flex align-items-center">
													<div class="flex-shrink-0">
														<img class="avatar avatar-xs avatar-4x3"
															src="<?= base_url();?>assets/svg/brands/frontapp-icon.svg"
															alt="Image Description" />
													</div>
													<div class="flex-grow-1 text-truncate ms-3">
											...
											<a class="dropdown-item" href="#">
												<div class="d-flex align-items-center">
													<div class="flex-shrink-0">
														<img class="avatar avatar-xs avatar-4x3"
															src="<?= base_url();?>assets/svg/illustrations/review-rating-shield.svg"
															alt="Image Description" />
													</div>
													<div class="flex-grow-1 text-truncate ms-3">
