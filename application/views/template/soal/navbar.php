	<!-- ========== HEADER ========== -->
	<header id="header" class="navbar navbar-expand-lg navbar-bordered navbar-spacer-y-0 flex-lg-column ms-0">
		<div class="navbar-light w-100 bg-white shadow-sm py-2">
			<div class="container-fuild px-5">
				<div class="navbar-nav-wrap">
					<!-- Logo -->
					<a class="navbar-brand d-block" href="<?= base_url();?>" aria-label="Front">
	...
	<main id="content" role="main" class="main splitted-content-main">
        <!-- Fluid Content -->
		<div class="splitted-content-fluid content-space p-0">
