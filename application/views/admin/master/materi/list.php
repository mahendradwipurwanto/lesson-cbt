			...
			<div class="row mb-4">
				...
				<div class="col-8">
					<div class="input-group mb-3">
						<input type="text" class="form-control" placeholder="Judul / Konten materi" name="search"
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-end"
										...
										<a class="dropdown-item" role="button" data-bs-toggle="modal"
											...
											<i class="bi-archive dropdown-item-icon"></i> Arsipkan
										</a>
			...
			<div class="card mb-3">
				...
				<div class="card-body">
					...
					<div class="card card-sm card-hover-shadow h-100 mb-3">
						...
						<a class="stretched-link" href="<?= site_url('master/buat-materi/');?>"></a>
					</div>
					<!-- End Card -->
					<!-- Card -->
