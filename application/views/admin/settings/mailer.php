<div class="row">
	<div class="col-md-7">
		<div class="card">
			<div class="card-body">
				<form action="<?= site_url('settings/ubahMailer');?>" method="post"
	...
	<div class="col-md-5">
		<div class="card card-body">
			...
			<form action="<?= site_url('settings/testMailer');?>" method="post" class="js-validate needs-validation"
				novalidate>
				<div class="mb-3">
			...
			<div class="code-toolbar mt-3">
				<pre
					class="language-markup w-100 p-2"><?= $this->session->userdata('mailer_debug') !== null ? $this->session->userdata('mailer_debug') : 'Send test mail first';?></pre>
			</div>
		</div>
	</div>
</div>
