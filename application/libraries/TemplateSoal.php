...
class TemplateSoal
{
    ...
    public function view($content, $data = null)
    {
        ...
        $this->_ci->load->view('template/soal/header', $data);
        $this->_ci->load->view('template/alert', $data);
        $this->_ci->load->view('template/soal/navbar', $data);
        $this->_ci->load->view($content, $data);
        $this->_ci->load->view('template/soal/aside', $data);
        $this->_ci->load->view('template/soal/footer', $data);
    }
}
